...
// dirty data-page sync ranges, recovery candidate rejection/acceptance, growth
// remaps, compact shrinks, stale reader cleanup, and obsolete metadata-page
// reclaim decisions as structured events. Mmap trees can grow the mapped file
// when allocation reaches the current capacity.
