...
// bytes visible to the old root. Current-tree Range and RangeFrom use those
// leaf links when no active reader can make them stale, and mmap-backed ranges
// prefetch a small window of exact next leaf pages with MADV_WILLNEED.
