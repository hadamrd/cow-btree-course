...
// before-growth-file-size-sync, and before-growth-remap boundaries; if a
// metadata publication fault or the final metadata flush fails, Sync restores
// the previous mapped metadata bytes before returning the error. Mmap trees can
