...
// Reopen validation checks metadata format, version, database page size, and
// bounds against the mapped file and declared capacity, page checksums, and
// slotted-page structure before decoding reachable cells, and it rejects branch
// routing that duplicates children or has separators that no longer match
