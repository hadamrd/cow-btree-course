...
- Runnable demos and tools in [`cmd/cowbtree`](cmd/cowbtree/), [`cmd/pagebtree-demo`](cmd/pagebtree-demo/), [`cmd/mmapbtree-demo`](cmd/mmapbtree-demo/), [`cmd/mdbkernel-demo`](cmd/mdbkernel-demo/), [`cmd/mmaptrace-demo`](cmd/mmaptrace-demo/), [`cmd/mmapinspect`](cmd/mmapinspect/), [`cmd/mmappunch`](cmd/mmappunch/), [`cmd/mmapreadersoak`](cmd/mmapreadersoak/), [`cmd/mmaptearlab`](cmd/mmaptearlab/), and [`cmd/benchsummary`](cmd/benchsummary/)
