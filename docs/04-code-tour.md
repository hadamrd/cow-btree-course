...
- `pagebtree/mmap.go` for `OpenMmap`, `OpenMmapReadOnly`, metadata recovery, dirty data-before-metadata sync, access-pattern advice, kernel cache stats, and file locking.
