...
- `pagebtree/mmap.go` for `OpenMmap`, `OpenMmapReadOnly`, metadata recovery, dirty data-before-metadata sync, tail compaction, access-pattern advice, tunable exact-page prefetch, kernel cache stats, and file locking.
