...
- `pagebtree/mmap.go` for `OpenMmap`, `OpenMmapReadOnly`, metadata recovery, dirty data-before-metadata sync, tail compaction, access-pattern advice, kernel cache stats, and file locking.
