...
- `cmd/mmapfsprobe` creates a disposable mmap database and reports local
  ...
  actual filesystem path, including filesystem type identity when available.
