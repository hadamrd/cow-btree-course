...
- Process-exit crash probes for direct sync publication, transaction commit
  followed by mmap sync publication, and legacy metadata upgrade publication.
