...
| Operations | Useful lab tools | `mmapinspect`, trace hooks, cache residency stats, compact-copy commands, bounded reader-table soak runner, and benchmarks exist. | No release process, no compatibility matrix, no corruption corpus management, and no production support envelope. |
