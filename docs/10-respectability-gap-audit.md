...
- Process-exit crash probes for direct sync publication, transaction commit
  followed by mmap sync publication, legacy metadata upgrade publication, and
  obsolete freelist metadata-generation reclaim.
