...
- `AuditReport` to expose validation evidence: current stats, reachable page
  IDs, reusable page IDs, retired page IDs, linked-leaf check state, and the
  same validation error that `Check` returns.
