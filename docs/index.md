...
pagebtree/
  ...
  mmap.go       Mmap-backed page arena, metadata recovery, sync, advice, and file locks
...
8. Read `docs/08-mmap-backed-pages.md` for kernel page-cache behavior and access-pattern advice.
