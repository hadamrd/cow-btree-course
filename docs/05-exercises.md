...
Keep the copy-on-write rule: clone any node before changing it. Then extend the page-backed implementation with branch-level sibling borrow, branch redistribution when merge cannot fit, and byte-balanced redistribution.
