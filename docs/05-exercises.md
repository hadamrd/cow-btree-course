...
Keep the copy-on-write rule: clone any node before changing it. Then extend the page-backed implementation with branch-level sibling borrow/merge and byte-balanced redistribution.
